...
initial_height = int(
    input("Enter the initial height from which the ball is dropped (in ft): "))

bounces = int(
    input("Enter the number of times the ball is allowed to continue bouncing: "))
...
print("The total distance traveled by the ball is", distance, "ft")
